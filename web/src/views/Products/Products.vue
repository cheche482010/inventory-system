            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr v-for="(product, index) in products" :key="product.id" v-else>
                  ...
                  <td>
                    <img v-if="product.imagen" :src="`${baseUrl}/uploads/${product.imagen}`" :alt="product.name" class="product-image img-thumbnail" style="width: 50px; height: 50px; object-fit: cover;">
