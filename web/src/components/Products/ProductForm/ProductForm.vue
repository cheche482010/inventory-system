      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="code" v-model="form.code" :class="{ 'is-invalid': errors.code }"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="file" class="form-control" id="imagen" @change="handleFileChange" accept="image/*"
              :disabled="loading" />
          </div>
          <div v-if="imagePreview || (isEdit && form.imagen)">
            <label class="form-label">Vista Previa</label>
            <img :src="imagePreview || form.imagen" alt="Vista previa de la imagen" class="img-thumbnail"
        ...
        <div class="col-md-4">
          <div class="mb-3">
            ...
            <select class="form-select" id="brandId" v-model="form.brandId" :class="{ 'is-invalid': errors.brandId }"
              required :disabled="loading">
